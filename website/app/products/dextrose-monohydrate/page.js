...
export default function Home() {
    const agarProductList = [
        {
            img: "/assets/newestBiotech/images/products/mextrose_monohydrate.jpeg",
            title: "Dextrose Monohydrate Food Grad...",
            desc: "Learn more",
            url: "#",
        },
    ]
    ...
    const title = "Dextrose Monohydrate"
